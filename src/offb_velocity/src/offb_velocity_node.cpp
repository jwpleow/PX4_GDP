...
// arguments are actually ENU!!!! arguments = (v_east, v_north, v_up, yaw, counts allowed before the next command [at 20Hz, 20 counts= 1s])
bool offboardVelocityCtrlNED(Drone& aero)
{
...
// arguments are (v_x, v_y, v_z, yawrate, counts allowed before the next command [at 20Hz, 20 counts= 1s])
bool offboardVelocityCtrlBody(Drone& aero)
{
...
void stepUp(Drone& aero)
{
  ...
  ROS_INFO("NED: Go Up");
  aero.setOffboardVelocityNED(0.0f, 0.0f, 2.0f, 180.0f, 40);
