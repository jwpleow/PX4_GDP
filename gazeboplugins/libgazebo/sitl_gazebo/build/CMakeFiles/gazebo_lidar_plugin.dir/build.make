...
CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.o: ../src/gazebo_lidar_plugin.cpp
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --progress-dir=/home/khorjiawei/Downloads/hector_gazebo/libgazebo/sitl_gazebo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_1) "Building CXX object CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.o"
	/usr/bin/c++  $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -o CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.o -c /home/khorjiawei/Downloads/hector_gazebo/libgazebo/sitl_gazebo/src/gazebo_lidar_plugin.cpp
...
CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.i: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -E /home/khorjiawei/Downloads/hector_gazebo/libgazebo/sitl_gazebo/src/gazebo_lidar_plugin.cpp > CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.i
...
CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.s: cmake_force
	...
	/usr/bin/c++ $(CXX_DEFINES) $(CXX_INCLUDES) $(CXX_FLAGS) -S /home/khorjiawei/Downloads/hector_gazebo/libgazebo/sitl_gazebo/src/gazebo_lidar_plugin.cpp -o CMakeFiles/gazebo_lidar_plugin.dir/src/gazebo_lidar_plugin.cpp.s
...
libgazebo_lidar_plugin.so: /usr/lib/x86_64-linux-gnu/libavutil.so
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_viz.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_videostab.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_superres.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_stitching.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_shape.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_video.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_photo.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_objdetect.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_calib3d.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_features2d.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_ml.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_highgui.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_videoio.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_imgcodecs.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_imgproc.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_flann.so.3.1.0
libgazebo_lidar_plugin.so: /usr/local/lib/libopencv_core.so.3.1.0
libgazebo_lidar_plugin.so: CMakeFiles/gazebo_lidar_plugin.dir/link.txt
	@$(CMAKE_COMMAND) -E cmake_echo_color --switch=$(COLOR) --green --bold --progress-dir=/home/khorjiawei/Downloads/hector_gazebo/libgazebo/sitl_gazebo/build/CMakeFiles --progress-num=$(CMAKE_PROGRESS_2) "Linking CXX shared library libgazebo_lidar_plugin.so"
